...
class _WebScraperAppState extends State<WebScraperApp> {
  ...
  final webScraper = WebScraper('https://www.coupang.com');
  ...
  void fetchProducts() async {
    ...
    if (await webScraper.loadWebPage(
        '/vp/products/6148872639?vendorItemId=79127247474&isAddedCart=')) {
      setState(() {
        // getElement takes the address of html tag/element and attributes you want to scrap from website
        // it will return the attributes in the same order passed
        productNames = webScraper.getElement('meta.og:title', ['content']);
        productDescriptions = webScraper.getElement(
            'div.ccid-badge > div.ccid-badge__inr > span.ccid-txt', ['class']);
      });
    }
  }
